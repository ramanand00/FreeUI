  ...
  return (
    ...
    <div className="max-w-4xl mx-auto px-6 py-40 text-gray-800">
      ...
      <Section title="1. Introduction">
        Welcome to <strong>FreeUI</strong> (<a href="https://prebuiltui.com" className="text-blue-600 underline">prebuiltui.com</a>). We are committed to providing a secure, privacy-respecting experience. This policy outlines how we handle user privacy.
      </Section>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>FreeUI is <strong>not affiliated</strong> with any external brands unless explicitly stated.</li>
      ...
      <p>
        ...
        <br />
        📧 <a href="mailto:ui@FreeUI.com" className="text-blue-600 underline">ui@FreeUI.com</a>
        <br />
